...
local function get_groups()
  ...
  local groups = {
    ...
    GruvboxPurple = { ctermfg = colors.purple },
    GruvboxPurpleBold = { ctermfg = colors.purple, bold = config.bold },
    GruvboxAqua = { ctermfg = colors.aqua },
    GruvboxAquaBold = { ctermfg = colors.aqua, bold = config.bold },
    ...
    GruvboxRedSign = config.transparent_mode and { ctermfg = colors.red, reverse = config.invert_signs }
      or { ctermfg = colors.red, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxGreenSign = config.transparent_mode and { ctermfg = colors.green, reverse = config.invert_signs }
      or { ctermfg = colors.green, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxYellowSign = config.transparent_mode and { ctermfg = colors.yellow, reverse = config.invert_signs }
      or { ctermfg = colors.yellow, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxBlueSign = config.transparent_mode and { ctermfg = colors.blue, reverse = config.invert_signs }
      or { ctermfg = colors.blue, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxPurpleSign = config.transparent_mode and { ctermfg = colors.purple, reverse = config.invert_signs }
      or { ctermfg = colors.purple, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxAquaSign = config.transparent_mode and { ctermfg = colors.aqua, reverse = config.invert_signs }
      or { ctermfg = colors.aqua, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxOrangeSign = config.transparent_mode and { ctermfg = colors.orange, reverse = config.invert_signs }
      or { ctermfg = colors.orange, bg = colors.bg1, reverse = config.invert_signs },
    ...
    TabLineSel = { ctermfg = colors.green, bg = colors.bg1, reverse = config.invert_tabline },
    TabLine = { link = "TabLineFill" },
    MatchParen = { bg = colors.bg3, bold = config.bold },
    ColorColumn = { bg = colors.bg1 },
    Conceal = { ctermfg = colors.blue },
    CursorLineNr = { ctermfg = colors.yellow, bg = colors.bg1 },
    NonText = { link = "GruvboxBg2" },
    SpecialKey = { link = "GruvboxFg4" },
    Visual = { bg = colors.bg3, reverse = config.invert_selection },
    VisualNOS = { link = "Visual" },
    Search = { ctermfg = colors.yellow, bg = colors.bg0, reverse = config.inverse },
    IncSearch = { ctermfg = colors.orange, bg = colors.bg0, reverse = config.inverse },
    ...
    WildMenu = { ctermfg = colors.blue, bg = colors.bg2, bold = config.bold },
    ...
    Folded = { ctermfg = colors.gray, bg = colors.bg1, italic = config.italic.folds },
    FoldColumn = config.transparent_mode and { ctermfg = colors.gray, bg = nil }
      or { ctermfg = colors.gray, bg = colors.bg1 },
    ...
    Operator = { ctermfg = colors.orange, italic = config.italic.operators },
    ...
    NvimTreeSymlink = { ctermfg = colors.neutral_aqua },
    NvimTreeRootFolder = { ctermfg = colors.neutral_purple, bold = true },
    NvimTreeFolderIcon = { ctermfg = colors.neutral_blue, bold = true },
    NvimTreeFileIcon = { ctermfg = colors.light2 },
    NvimTreeExecFile = { ctermfg = colors.neutral_green, bold = true },
    NvimTreeOpenedFile = { ctermfg = colors.bright_red, bold = true },
    NvimTreeSpecialFile = { ctermfg = colors.neutral_yellow, bold = true, underline = true },
    NvimTreeImageFile = { ctermfg = colors.neutral_purple },
    NvimTreeIndentMarker = { ctermfg = colors.dark3 },
    NvimTreeGitDirty = { ctermfg = colors.neutral_yellow },
    NvimTreeGitStaged = { ctermfg = colors.neutral_yellow },
    NvimTreeGitMerge = { ctermfg = colors.neutral_purple },
    NvimTreeGitRenamed = { ctermfg = colors.neutral_purple },
    NvimTreeGitNew = { ctermfg = colors.neutral_yellow },
    NvimTreeGitDeleted = { ctermfg = colors.neutral_red },
    ...
    DashboardFooter = { ctermfg = colors.purple, italic = true },
    ...
    NoiceCmdlinePopupBorder = { ctermfg = colors.blue, bg = nil },
    NoiceCmdlineIcon = { link = "NoiceCmdlinePopupBorder" },
    NoiceConfirmBorder = { link = "NoiceCmdlinePopupBorder" },
    NoiceCmdlinePopupBorderSearch = { ctermfg = colors.yellow, bg = nil },
    ...
    TSRainbowViolet = { ctermfg = colors.purple },
    TSRainbowCyan = { ctermfg = colors.aqua },
    ...
    RainbowDelimiterViolet = { ctermfg = colors.purple },
    RainbowDelimiterCyan = { ctermfg = colors.aqua },
    DapBreakpointSymbol = { ctermfg = colors.red, bg = colors.bg1 },
    DapStoppedSymbol = { ctermfg = colors.green, bg = colors.bg1 },
    ...
    DapUIPlayPause = { ctermfg = colors.green, bg = colors.bg1 },
    DapUIRestart = { ctermfg = colors.green, bg = colors.bg1 },
    DapUIScope = { link = "GruvboxBlue" },
    DapUISource = { link = "GruvboxFg1" },
    DapUIStepBack = { ctermfg = colors.blue, bg = colors.bg1 },
    DapUIStepInto = { ctermfg = colors.blue, bg = colors.bg1 },
    DapUIStepOut = { ctermfg = colors.blue, bg = colors.bg1 },
    DapUIStepOver = { ctermfg = colors.blue, bg = colors.bg1 },
    DapUIStop = { ctermfg = colors.red, bg = colors.bg1 },
    ...
    ["@text.note.comment"] = { ctermfg = colors.purple, bold = config.bold },
